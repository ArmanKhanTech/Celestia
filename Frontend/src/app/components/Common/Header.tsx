...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 lg:max-h-20 w-full bg-base-100 px-5 py-5 border-b flex flex-col gap-4 justify-between lg:mx-auto lg:flex-row lg:items-center z-50">
      ...
      >
        <ul className="flex flex-col w-full lg:self-end items-center space-y-3 lg:ml-auto lg:flex-row lg:space-x-2 lg:space-y-0">
          ...
          <Link
            className="rounded-full text-center lg:w-28 border-2 px-6 py-1 bg-base-100 w-full"
            href="/login"
          >
            Login
          </Link>
